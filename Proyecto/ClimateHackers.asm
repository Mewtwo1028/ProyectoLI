...
.data  
    ...
    LOGO1 db '               ...  **.                                                         '               
        ...
        msj2 db '2. Analizar una zona específica';31
        msj3 db '3. Calcular calidad del aire';28
        msj4 db '4. Revisar el último reporte';28
        msj5 db '5. Salir';8 
        espacio db '                                        '
...
;Aquí va el logo
       ...
       INC REN 
            ...
            INC REN
            interfazMenu r17,ren 
            INC REN
            interfazMenu r22,ren
            INC REN
            interfazMenu r23,ren
            INC REN
            interfazMenu r24,ren
            
    
IMP_CAD_COLOR msj1,20,5,40,1FH,0,0F0h 
IMP_CAD_COLOR msj2,31,6,40,1FH,0,0F0h
IMP_CAD_COLOR msj3,28,7,40,1FH,0,0F0h
IMP_CAD_COLOR msj4,28,8,40,1FH,0,0F0h
IMP_CAD_COLOR msj5,8,9,40,1FH,0,0F0h                    
